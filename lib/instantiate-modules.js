...
module.exports = {
  ...
  instantiateExternalDependency: instantiateExternalDependency,
...
function instantiateExternalDependencies(externalDependencies) {
  ...
  _.each(externalDependencies, function(truly, externalDependency) {
    instantiateExternalDependency(externalDependencies, externalDependency);
  });
  logger.high('Finished instantiation of external libraries');
}

function instantiateExternalDependency(externalDependencies, externalDependency) {
  try {
